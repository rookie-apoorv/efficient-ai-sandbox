# CS6013 — Compression 20 — Submission 01 (GPTQ, int2/int4)
...
| Compressed model | group-wise `int2` / `int4`, asymmetric with **integer** zero-point, group size 128; `float16` scales, `uint8` zero-points; small tensors kept at base dtype |
